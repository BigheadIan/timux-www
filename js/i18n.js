...
const translations = {
    'zh-TW': {
        ...
        'about.tech4': '數據分析',
        'about.events': '活動與演講',
        'about.event1': '2026 台灣青年自媒體創業加速營暨武漢深度考察營',
        'about.event2': 'AI 創業分享 — OpenClaw 私人 AI 管家',
        'contact.title': '聯繫我們',
    ...
    'zh-CN': {
        ...
        'about.tech4': '数据分析',
        'about.events': '活动与演讲',
        'about.event1': '2026 台湾青年自媒体创业加速营暨武汉深度考察营',
        'about.event2': 'AI 创业分享 — OpenClaw 私人 AI 管家',
        'contact.title': '联系我们',
    ...
    'en': {
        ...
        'about.events': 'Events & Talks',
        'about.event1': '2026 Taiwan Youth Self-Media Entrepreneurship Accelerator & Wuhan Study Tour',
        'about.event2': 'AI Entrepreneurship Talk — OpenClaw Personal AI Butler',
