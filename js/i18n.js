...
const translations = {
    'zh-TW': {
        ...
        'products.fortune.tagline': '把命理推算交給 AI，讓你有更多時間活出精彩',
        'products.fortune.desc': '結合傳統命理學與現代 AI 技術，提供個人化的命理分析與人生建議。用 AI 的理性為感性的人生決策提供參考。',
    ...
    'zh-CN': {
        ...
        'products.fortune.name': 'AI 智能算命',
        'products.fortune.tagline': '把命理推算交给 AI，让你有更多时间活出精彩',
        'products.fortune.desc': '结合传统命理学与现代 AI 技术，提供个性化的命理分析与人生建议。用 AI 的理性为感性的人生决策提供参考。',
    ...
    'en': {
        ...
        'products.fortune.tagline': 'Let AI handle fortune calculations so you have more time to live brilliantly',
        'products.fortune.desc': 'Combining traditional fortune telling with modern AI technology to provide personalized destiny analysis and life advice. Using AI rationality as reference for emotional life decisions.',
