...
const translations = {
    'zh-TW': {
        ...
        'products.aics.caseLabel': '東南客運案例截圖',
        'products.aics.caseTag': '路線問答 / 即時到站 / 人工轉接',
        'products.digitalhuman.name': 'AI 分身員工',
        'products.digitalhuman.tagline': '把知識、聲音與服務流程，做成會對話的 AI 分身',
        'products.digitalhuman.desc': '為企業與個人打造可對外服務的 AI 數字人工作台。上傳知識庫、生成基礎 Prompt、用訪談方式錄製聲音樣本，讓 AI 分身可以介紹服務、回答客戶問題、沉澱專屬資料。',
        'products.digitalhuman.f1': '📚 上傳資料形成專屬知識庫',
        'products.digitalhuman.f2': '🧠 生成可編輯的基礎 Prompt',
        'products.digitalhuman.f3': '🎙️ 訪談式錄音保存語音樣本',
        'products.digitalhuman.f4': '🏢 多租戶工作台管理數字人',
        'products.digitalhuman.demo': '體驗 AI 分身員工',
        'products.digitalhuman.trial': '預約導入',
        'products.digitalhuman.img1': '📚 知識庫',
        'products.digitalhuman.img2': '🧠 Prompt',
        'products.digitalhuman.img3': '🎙️ 聲音樣本',
        'products.digitalhuman.img4': '🚀 對外服務',
        ...
        'contact.opt.digitalhuman': 'AI 分身員工',
        ...
        'cases.title': '實績案例',
        'cases.subtitle': '把近期導入成果，用真實介面截圖呈現',
        'cases.southeast.category': 'AI 智能客服',
        'cases.southeast.title': '東南客運 AI 客服',
        'cases.southeast.desc': '導入租戶式客服訓練、錄音分析、路線/班表問答與真人轉接流程，讓大量客運客服問題可被分類、學習與追蹤。',
        'cases.southeast.img1': '路線問答',
        'cases.southeast.img2': '即時資訊處理',
        'cases.mj.category': 'LINE 數據整理',
        'cases.mj.title': '銘將保全 LINE 數據整理',
        'cases.mj.desc': '保全群組照片、打卡、請假、加班、任務與薪資資料整合到 LINE Bot 與 LIFF 手機頁，現場人員不用進後台也能完成日常操作。',
        'cases.mj.img1': 'LINE Bot',
        'cases.mj.img2': 'LIFF 打卡',
        'cases.mj.img3': '出勤月曆',
        'founder.title': '創辦人',
        'founder.name': '黃昱仁',
    ...
    'zh-CN': {
        ...
        'products.aics.caseLabel': '东南客运案例截图',
        'products.aics.caseTag': '路线问答 / 即时到站 / 人工转接',
        'products.digitalhuman.name': 'AI 分身员工',
        'products.digitalhuman.tagline': '把知识、声音与服务流程，做成会对话的 AI 分身',
        'products.digitalhuman.desc': '为企业与个人打造可对外服务的 AI 数字人工作台。上传知识库、生成基础 Prompt、用访谈方式录制声音样本，让 AI 分身可以介绍服务、回答客户问题、沉淀专属资料。',
        'products.digitalhuman.f1': '📚 上传资料形成专属知识库',
        'products.digitalhuman.f2': '🧠 生成可编辑的基础 Prompt',
        'products.digitalhuman.f3': '🎙️ 访谈式录音保存语音样本',
        'products.digitalhuman.f4': '🏢 多租户工作台管理数字人',
        'products.digitalhuman.demo': '体验 AI 分身员工',
        'products.digitalhuman.trial': '预约导入',
        'products.digitalhuman.img1': '📚 知识库',
        'products.digitalhuman.img2': '🧠 Prompt',
        'products.digitalhuman.img3': '🎙️ 声音样本',
        'products.digitalhuman.img4': '🚀 对外服务',
        ...
        'contact.opt2': 'AI 智能客服',
        'contact.opt.digitalhuman': 'AI 分身员工',
        ...
        'cases.title': '实绩案例',
        'cases.subtitle': '把近期导入成果，用真实界面截图呈现',
        'cases.southeast.category': 'AI 智能客服',
        'cases.southeast.title': '东南客运 AI 客服',
        'cases.southeast.desc': '导入租户式客服训练、录音分析、路线/班表问答与真人转接流程，让大量客运客服问题可被分类、学习与追踪。',
        'cases.southeast.img1': '路线问答',
        'cases.southeast.img2': '即时资讯处理',
        'cases.mj.category': 'LINE 数据整理',
        'cases.mj.title': '铭将保全 LINE 数据整理',
        'cases.mj.desc': '保全群组照片、打卡、请假、加班、任务与薪资资料整合到 LINE Bot 与 LIFF 手机页，现场人员不用进后台也能完成日常操作。',
        'cases.mj.img1': 'LINE Bot',
        'cases.mj.img2': 'LIFF 打卡',
        'cases.mj.img3': '出勤月历',
        'founder.title': '创办人',
    ...
    'en': {
        ...
        'products.aics.caseLabel': 'Southeast Bus case screenshots',
        'products.aics.caseTag': 'Route Q&A / ETA / human handoff',
        'products.digitalhuman.name': 'AI Digital Human Employee',
        'products.digitalhuman.tagline': 'Turn knowledge, voice, and service workflows into a conversational AI representative',
        'products.digitalhuman.desc': 'A digital human workspace for businesses and personal brands. Upload knowledge, generate an editable base prompt, collect voice samples through guided interviews, and let your AI representative introduce services and answer customer questions.',
        'products.digitalhuman.f1': '📚 Upload documents into a dedicated knowledge base',
        'products.digitalhuman.f2': '🧠 Generate editable base prompts',
        'products.digitalhuman.f3': '🎙️ Save interview-style voice samples',
        'products.digitalhuman.f4': '🏢 Manage digital humans in a multi-tenant workspace',
        'products.digitalhuman.demo': 'Try AI Digital Human',
        'products.digitalhuman.trial': 'Book Onboarding',
        'products.digitalhuman.img1': '📚 Knowledge',
        'products.digitalhuman.img2': '🧠 Prompt',
        'products.digitalhuman.img3': '🎙️ Voice Samples',
        'products.digitalhuman.img4': '🚀 Service Ready',
        ...
        'contact.opt.digitalhuman': 'AI Digital Human Employee',
        ...
        'cases.subtitle': 'Recent implementations shown with real interface screenshots',
        'cases.southeast.category': 'AI Customer Service',
        'cases.southeast.title': 'Southeast Bus AI Customer Service',
        'cases.southeast.desc': 'Tenant training, audio analysis, route/schedule Q&A, and human handoff workflows help classify, learn from, and track high-volume transit service questions.',
        'cases.southeast.img1': 'Route Q&A',
        'cases.southeast.img2': 'Real-time support',
        'cases.mj.category': 'LINE Data Operations',
        'cases.mj.title': 'MJ Security LINE Data Operations',
        'cases.mj.desc': 'Security group photos, attendance, leave, overtime, tasks, and payroll data are integrated into a LINE Bot and LIFF mobile pages for field-first operations.',
        'cases.mj.img1': 'LINE Bot',
        'cases.mj.img2': 'LIFF Clock-in',
        'cases.mj.img3': 'Attendance Calendar',
