...
const translations = {
    'zh-TW': {
        ...
        'hero.title1': '用 AI 重新定義',
        'hero.title2': '商業智能',
        'hero.subtitle': '時光智造專注於開發 AI 智能解決方案，幫助企業實現數位轉型，提升營運效率，創造更大價值。',
        'hero.cta1': '探索產品',
        'hero.cta2': '聯繫我們',
    ...
    'zh-CN': {
        ...
        'hero.title1': '用 AI 重新定义',
        'hero.title2': '商业智能',
        'hero.subtitle': '时光智造专注于开发 AI 智能解决方案，帮助企业实现数字化转型，提升运营效率，创造更大价值。',
        'hero.cta1': '探索产品',
        'hero.cta2': '联系我们',
    ...
    'en': {
        ...
        'hero.title1': 'Redefine Business',
        'hero.title2': 'Intelligence with AI',
        'hero.subtitle': 'Timux is dedicated to developing AI-powered solutions that help businesses achieve digital transformation, improve operational efficiency, and create greater value.',
        ...
        'products.aics.img2': 'Analytics Dashboard',
        ...
        'contact.opt4': 'Other / Partnership',
